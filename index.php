        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="box-wrap">
              ...
              <p class="mt-3">Understanding the roles of each member of your healthcare team is important, especially when managing a chronic condition. Knowing what each professional does, and the differences between roles, will help you, the patient at the center of everyone’s job.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12 mt-md-0 mt-4">
            <div class="box-wrap">
              ...
              <p class="mt-3">Service quality and patient satisfaction have a significant impact in health care. Patients’ perceptions of hospital facilities affect the image and cost-effectiveness of the hospital.60 Perceived service quality also determines patients’ loyalty and word-of-mouth behavior.</p>
            </div>
          </div>
    ...
    <div class="container py-lg-5 py-md-4 py-2">
      <div class="row w3l-content-inf mt-lg-5 pt-lg-5">
        ...
        <div class="col-lg-7 w3l-content-right pl-lg-5 mt-lg-4">
          ...
          Online doctors see and treat patients virtually using medick. With virtual doctor visits, you can see a doctor online and get medical advice along with necessary prescriptions
          </p>
          <p class="para-sub pr-lg-5 mt-md-4 mt-3 mx-auto">
          Getting care at home with an online doctor appointment is convenient for social distancing, or if you’re short on time, transportation, or child care. While medick can’t replace face-to-face medical care entirely, it can break down barriers to accessing health care.
          </p>
          ...
          <div class="content-left col-lg-6">
            <div class="row content4-right-grids mb-sm-5 mb-4">
              ...
              <div class="col-lg-10 col-9 content4-right-info pl-4">
                <h6><a href="#url">Intensive Care (Critical Care)</a></h6>
                <p>A special level of care for those who are hospitalized and require close monitoring on a 24-hour basis..</p>
              </div>
            </div>
            <div class="row content4-right-grids mb-sm-5 mb-4">
              <div class="col-lg-2 col-3 content4-right-icon">
              ...
              <div class="col-lg-10 col-9 content4-right-info pl-4">
                ...
                <p>The department of dentistry has highly skilled and experienced consultants who provide a number of dental services.</p>
              </div>
            </div>
            <div class="row content4-right-grids mb-sm-5 mb-4">
              <div class="col-lg-2 col-3 content4-right-icon">
              ...
              <div class="col-lg-10 col-9 content4-right-info pl-4">
                ...
                <p> Virologists are medical doctors that oversee the diagnosis, management and prevention of infection. They’re also scientists, who may drive research on various aspects of viruses.</p>
              </div>
            </div>
          </div>
          <div class="content-right col-lg-6 pl-lg-4 mt-lg-0 mt-2">
            <div class="row content4-right-grids mb-sm-5 mb-4">
              ...
              <div class="col-lg-10 col-9 content4-right-info pl-4">
                ...
                <p> Pharmacy practicing doctors provide patient care that optimizes medication therapy and promotes health.</p>
              </div>
            </div>
            <div class="row content4-right-grids mb-sm-5 mb-4">
              <div class="col-lg-2 col-3 content4-right-icon">
              ...
              <div class="col-lg-10 col-9 content4-right-info pl-4">
                ...
                <p>Care for diseases, conditions of the heart and blood circulatory system.
                  </p>
              </div>
            </div>
            <div class="row content4-right-grids">
              ...
              <div class="col-lg-10 col-9 content4-right-info pl-4">
                <h6><a href="#url"> Eye Service(optometry)</a></h6>
                <p>Eye care services including eye examinations, contact lens fitting, treatment for infections and specialized vision testing.
                  .</p>
              </div>
            </div>
          </div>
          ...
          <div class="item">
            <div class="testimonial-content">
              <div class="testimonial">
                ...
                <p>I come from a family of doctors and I was suffering from morbid obesity with co-morbidities like diabetes, hypertension, and sleep apnoea. It was becoming increasingly difficult for me to concentrate on my practice and continue my day today life. I’ve been consulted…
                 </p>
